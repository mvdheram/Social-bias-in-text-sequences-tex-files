...
\begin{itemize}
    ...
    \item Training process
        ...
        \end{figure}
            ...
            \item Fine-tuning to target specific task (classification in our case) with target specific data (Multi-label dataset) by removing the language model head which is 
            \begin{itemize}
                \item 
            \end{itemize}
